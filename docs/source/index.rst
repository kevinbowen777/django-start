...
The purpose of the django-start_ project is to provide a template repository for the collection of `Web Framework Projects`_ . This repository runs a Django 6.x application demonstrating some of the basic functionality also available in the applications listed in the Web Frameworks repository.
